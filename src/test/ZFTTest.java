...
public class ZFTTest {
    ...
    public void ZFT_Corner_UpLeft() {
        Pad padA = new Pad("padA", new Pos2D(0, 1));
        Pad padB = new Pad("padB", new Pos2D(1, 0));
    ...
    public void ZFT_AllCorners() {
        Pad padA = new Pad("padA", new Pos2D(1, 1));
        Pad padB = new Pad("padB", new Pos2D(3, 1));
        Pad padC = new Pad("padC", new Pos2D(1, 3));
        Pad padD = new Pad("padD", new Pos2D(3, 3));
    ...
    public void ZFT_MiddleLeft() {
        Pad padA = new Pad("padA", new Pos2D(4, 1));
        Pad padB = new Pad("padB", new Pos2D(4, 3));
